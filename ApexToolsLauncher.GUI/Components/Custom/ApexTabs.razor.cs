...
public partial class ApexTabs : MudComponentBase, IAsyncDisposable
{
    ...
    [Parameter]
    [Category(CategoryTypes.Tabs.Behavior)]
    public RenderFragment<ApexTabPanel>? PrePanelContent { get; set; }
    ...
    public ApexTabPanel? ActivePanel { get; private set; }
    ...
    /// </summary>
    public IReadOnlyList<ApexTabPanel> Panels { get; private set; }

    private List<ApexTabPanel> _panels;
    ...
    [Parameter]
    [Category(CategoryTypes.Tabs.Behavior)]
    public RenderFragment<ApexTabs>? Header { get; set; }
    ...
    [Parameter]
    [Category(CategoryTypes.Tabs.Behavior)]
    public RenderFragment<ApexTabPanel>? TabPanelHeader { get; set; }
    ...
    internal void AddPanel(ApexTabPanel tabPanel)
    {
    ...
    internal async Task RemovePanel(ApexTabPanel tabPanel)
    {
        if (_isDisposed)
            return;
    ...
    public void ActivatePanel(ApexTabPanel? panel, bool ignoreDisabledState = false)
    {
    ...
    private async void ActivatePanel(ApexTabPanel panel, MouseEventArgs? ev, bool ignoreDisabledState = false)
    {
    ...
    string GetTabClass(ApexTabPanel panel)
    {
    ...
    string GetTabStyle(ApexTabPanel panel)
    {
    ...
    private Color GetPanelIconColor(ApexTabPanel panel)
    {
    ...
    private double GetLengthOfPanelItems(ApexTabPanel panel, bool inclusive = false)
    {
        var value = 0.0;
    ...
    private double GetPanelLength(ApexTabPanel? panel) => panel == null ? 0.0 : GetRelevantSize(panel.PanelRef);
    ...
    private bool ScrollToItem(ApexTabPanel panel, bool isLast = false)
    {
